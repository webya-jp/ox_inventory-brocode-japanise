...
const InventoryContext: React.FC = () => {
  ...
  return (
    <>
      <Menu>
        <MenuItem onClick={() => handleClick({ action: 'use' })} label={Locale.ui_use || '使用'} />
        <MenuItem onClick={() => handleClick({ action: 'give' })} label={Locale.ui_give || '渡す'} />
        <MenuItem onClick={() => handleClick({ action: 'drop' })} label={Locale.ui_drop || '落とす'} />
