  ...
  return (
    <div className="group">
      <div className="overlap-group">
        {isMounted && (
          <FloatingPortal>
            <div ref={refs.setFloating} style={{ ...floatingStyles, ...styles, color: 'white' }}>
              <div style={{ fontSize: '0.9vw', fontWeight: 600 }}>{bodypart}</div>
              <div
                style={{
                  width: '14vw',
                  height: '8vw',
                ...
                <div style={{ width: '0%', height: '10%', margin: '0.5vw', position: 'absolute' }}>
                  ...
                  >
                    ...
                    <div
                      style={{
                        width: '50%',
                        background:
                          bodydamagecal[bodypart]?.bullets > 0 ? 'rgba(166, 43, 43, 0.6)' : 'rgb(60, 179, 113)',
                        display: 'flex',
                        alignContent: 'center',
                        alignItems: 'center',
                        justifyContent: 'center',
                  ...
                  >
                    ...
                    <div
                      style={{
                        width: '50%',
                        background: bodydamagecal[bodypart]?.broken ? 'rgba(166, 43, 43, 0.6)' : 'rgb(60, 179, 113)',
                        display: 'flex',
                        alignContent: 'center',
                        alignItems: 'center',
                        justifyContent: 'center',
                  ...
                  >
                    ...
                    <div
                      style={{
                        width: '50%',
                        background: bodydamagecal[bodypart]?.severity ? 'rgba(166, 43, 43, 0.6)' : 'rgb(60, 179, 113)',
                        display: 'flex',
                        alignContent: 'center',
                        alignItems: 'center',
                        justifyContent: 'center',
                  ...
                  >
                    ...
                    <div
                      style={{
                        width: '50%',
                        background: bodydamagecal[bodypart]?.bleeding ? 'rgba(166, 43, 43, 0.6)' : 'rgb(60, 179, 113)',
                        display: 'flex',
                        alignContent: 'center',
                        alignItems: 'center',
                        justifyContent: 'center',
        ...
        <div
          onMouseEnter={() => {
            setHoverData(true);
            setBodypart('LOWER_BODY');
          }}
          onMouseLeave={() => {
            setHoverData(false);
          }}
          className="lowerbodyyy"
          style={{
            width: '6.5vw',
            height: '5vw',
            position: 'absolute',
        ...
        <Arrowright
          ...
          durablitystyles={{ width: '5vw', marginLeft: '15.5vw', marginTop: '1vw', position: 'absolute' }}
          label={'頭'}
          percent={100 - bodydamagecal['HEAD']?.percent}
        />
        <Arrowright
          styles={{
            width: '10vw',
          ...
          durablitystyles={{ width: '5vw', marginLeft: '19.5vw', marginTop: '7.5vw', position: 'absolute' }}
          label={'右腕'}
          percent={100 - bodydamagecal['RARM']?.percent}
        />
        <Arrowright
          styles={{
            width: '10vw',
          ...
          durablitystyles={{ width: '5vw', marginLeft: '16.5vw', marginTop: '24.5vw', position: 'absolute' }}
          label={'右足'}
          percent={100 - bodydamagecal['RLEG']?.percent}
        />
        <Arrowleft
          styles={{
            width: '10vw',
          ...
          durablitystyles={{ width: '5vw', marginLeft: '1.7vw', marginTop: '24.5vw', position: 'absolute' }}
          label={'左足'}
          percent={100 - bodydamagecal['LLEG']?.percent}
        />
        <Arrowleft
          styles={{
            width: '10vw',
          ...
          durablitystyles={{ width: '5vw', marginLeft: '1.8vw', marginTop: '7.5vw', position: 'absolute' }}
          label={'左腕'}
          percent={100 - bodydamagecal['LARM']?.percent}
        />
        <img
          className="UPPERBODY"
          style={{
